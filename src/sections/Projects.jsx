...
const Projects = () => {
  ...
  return (
    <section className='c-space my-20' id="work">
        ...
        <div className='grid lg:grid-cols-2 grid-cols-1 gap-10 mt-12 gap-5 w-full'>
            ...
            <div className='flex flex-col gap-5 relative sm:p-10 py-10 px-5 shadow-2xl shadow-black-200'>
                ...
                <div className='p-3 backdrop-filter backdrop-blur-3xl w-fit rounded-lg' style={currentProject.logoStyle}>
                    ...
                    <img src={currentProject.logo} alt="logo" className='w-10 h-10 object-contain shadow-sm ' />
                ...
                <div className='flex justify-between items-center mt-7'>
                    <button className='arrow-btn' onClick={()=>handleNavigation('prev')}>
                        <img src="/assets/left-arrow.png" alt="arrow" className='w-5 h-4 object-contain' />
                        
                    </button>
                    <button className='arrow-btn' onClick={()=>handleNavigation('next')}>
                        <img src="/assets/right-arrow.png" alt="arrow" className='w-5 h-4 object-contain' />
