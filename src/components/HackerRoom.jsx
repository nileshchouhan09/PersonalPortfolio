...
export default function HackerRoom(props) {
  const screenTXt = useTexture("/customImages/screen2.png")
  const { nodes, materials } = useGLTF('/models/gaming_setup (1).glb')
  return (
    <group {...props} dispose={null}>
      <group scale={0.22} rotation={[0.2,1.50,-0.12]} position={[-30,0,0]}>
        <group
...
useGLTF.preload('/models/gaming_setup (1).glb')
